...
public class desertsMenu extends AppCompatActivity {
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myref = mydata.getReference().child("menu").child("Deserts");
        ...
        myref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                adapter = new CustomListAdapter(desertsMenu.this, R.layout.main_layout, list);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deserts_menu);

        mydata = FirebaseDatabase.getInstance();
        myref = mydata.getReference().child("menu").child("Deserts");

        lv = (ListView) findViewById(R.id.desertsListView);
        myref.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                Item value = dataSnapshot.getValue(Item.class);
                ...
                //arrayList.add(value.getName());
                arrayAdapter = new ArrayAdapter<String>(desertsMenu.this, android.R.layout.simple_list_item_1, arrayList);
                lv.setAdapter(arrayAdapter);
            }
